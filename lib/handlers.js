...
handlers._users.post = (data, callback) => {
  ...
  const firstName = typeof (data.payload.firstName) == 'string' && data.payload.firstName.trim().length > 0 ? data.payload.firstName.trim() : false,
    ...
    phone = typeof (data.payload.phone) == 'string' && data.payload.phone.trim().length == 14 ? data.payload.phone.trim() : false,
    password = typeof (data.payload.password) == 'string' && data.payload.trim().password.length > 0 ? data.payload.trim().password : false,
